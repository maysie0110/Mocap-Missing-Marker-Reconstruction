...
def home_out(path):
    goal_dir = os.path.join(os.getcwd(), "summary2", path)
...
flags.DEFINE_integer('chkpt_num' , 134600, 'Number of the checkpoint')
...
#             'D:/NN-for-Missing-Marker-Reconstruction/Datasets/30k_90L',
#                    'Directory to put the training data.')

flags.DEFINE_string('data_dir',os.path.join(os.getcwd(), "Datasets/30k_90L"),
                    'Directory to put the training data.')
flags.DEFINE_string('real_data_dir',os.path.join(os.getcwd(), "Datasets/real_data"),
                    'Directory to put the real test data.')
